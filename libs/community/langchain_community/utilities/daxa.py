...
file_loader = ['JSONLoader', 'S3FileLoader', 'UnstructuredMarkdownLoader', 'UnstructuredPDFLoader',
               ...
               'AmazonTextractPDFLoader', 'CSVLoader', 'UnstructuredExcelLoader']
...
def get_loader_full_path(loader):
    ...
    from langchain_community.document_loaders import DataFrameLoader, GCSFileLoader, S3FileLoader
    location = "-"
...
def get_runtime() -> Tuple[Framework, Runtime]:
    ...
    framework = Framework(
        name="langchain",
        version=runtime_env.get('library_version', None)
    )
